...
const InterviewForm = () => {
  ...
  const startInterview = () => {
    // Perform actions when the "Start Interview" button is clicked
    ...
    <div className="flex flex-col rounded-md p-5 gap-3">
      ...
      <form className="flex flex-col gap-5">
        ...
        <button
          ...
          class="text-white bg-gradient-to-r from-cyan-400 via-cyan-500 to-cyan-600 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-cyan-300 dark:focus:ring-cyan-800 font-medium rounded-lg px-5 py-7 text-center me-2 mb-2"
        >
          START INTERVIEW
        </button>
      </form>
